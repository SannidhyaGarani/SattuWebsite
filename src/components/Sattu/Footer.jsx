            ...
            <div className="flex gap-3 pt-2">
              {[Instagram, Facebook, Youtube, Twitter].map((Icon, i) => (
                <a 
                  key={i} 
                  href="#" 
                  className="w-9 h-9 rounded-full border border-[#E3DBC5] bg-[#FFFDF6] flex items-center justify-center text-[#203B23]/70 hover:bg-[#203B23] hover:text-[#FAF4E3] hover:border-[#203B23] transition-all duration-400 shadow-sm"
                >
