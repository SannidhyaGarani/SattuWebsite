      ...
      <header className="fixed top-0 left-0 w-full z-[100] transition-all duration-500">
          ...
          <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
            ...
            <div className="md:hidden">
              <button
                ...
                className="text-[#6b4f3] p-2 bg-[#6b4f3]/5 rounded-xl border border-[#6b4f3]/10"
              >
                <Menu size={20} />
              </button>
            </div>
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            ...
            >
              <div className="w-full px-6 h-[80px] flex items-center justify-between border-b border-[#6b4f3]/5 absolute top-0 left-0">
                <span className="text-xl font-poppins font-black text-[#6b4f3] uppercase tracking-tight">Archives</span>
                <button
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="bg-[#6b4f3] text-white p-2 rounded-full"
                >
                  <X size={20} />
                </button>
              </div>
