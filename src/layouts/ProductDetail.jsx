...
const ProductDetail = () => {
  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-[#FAF4E3] flex flex-col items-center justify-center text-center p-6 relative">
        ...
        <h3 className="text-2xl font-poppins font-bold text-[#203B23] mb-3">Archive Unresolved</h3>
        <p className="text-xs text-[#203B23]/70 font-poppins max-w-sm mx-auto mb-10 leading-relaxed tracking-wide">
          The unique parameter tracking index could not identify a correlated artisanal blend within our registry.
        </p>
        <Link to="/shop" className="inline-flex items-center gap-3 px-8 py-4 bg-[#203B23] text-[#FFFDF6] font-bold text-[10px] uppercase tracking-[0.25em] rounded-xl hover:bg-[#976E2A] transition-all duration-300 shadow-[0_10px_20px_rgba(32,59,35,0.15)]">
  ...
  return (
    <div 
      className="min-h-screen relative pt-12 pb-32 text-[#203B23] selection:bg-[#976E2A] selection:text-[#FFFDF6] bg-cover bg-center"
      ...
      <AnimatePresence>
        {feedbackMessage && (
          <motion.div 
            ...
            className="fixed bottom-12 left-1/2 z-50 bg-[#FFFDF6] border border-[#976E2A]/30 text-[#203B23] px-6 py-4 rounded-xl shadow-[0_20px_40px_rgba(151,110,42,0.12)] flex items-center gap-4 max-w-md w-[90%]"
          >
            ...
            <button onClick={() => setFeedbackMessage(null)} className="text-[#203B23]/40 hover:text-[#976E2A] transition-colors">
              <X size={16} />
            </button>
          </motion.div>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 xl:gap-24 items-start">
          ...
          <div className="lg:col-span-6 space-y-10">
            ...
            >
              <div className="w-full h-full overflow-hidden rounded-[34px] relative bg-[#FAF4E3] flex items-center justify-center p-12">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#203B23]/5 via-transparent to-transparent opacity-60 pointer-events-none z-10" />
                ...
                <div className="absolute top-6 left-6 z-20">
                  <span className="px-5 py-2.5 rounded-full bg-[#FFFDF6]/90 backdrop-blur-md text-[9px] font-poppins font-bold uppercase tracking-[0.25em] text-[#203B23] border border-[#E3DBC5] shadow-[0_4px_12px_rgba(32,59,35,0.08)]">
                ...
                {product.stock_status && (
                  <div className="absolute bottom-6 right-6 z-20">
                    <span className={`px-4 py-2.5 rounded-full text-[9px] font-poppins font-bold uppercase tracking-[0.25em] border shadow-[0_4px_12px_rgba(32,59,35,0.06)] backdrop-blur-sm ${
                      product.stock_status === 'In Stock' 
                        ? 'bg-[#FFFDF6]/90 text-[#203B23] border-[#203B23]/20' 
              ...
              {[
                ...
                return (
                  <div key={i} className="flex flex-col items-center text-center p-5 rounded-[24px] bg-[#FFFDF6] border border-[#E3DBC5]/80 space-y-3 shadow-[0_4px_12px_rgba(32,59,35,0.03)] transition-all duration-500 hover:border-[#976E2A]/40 hover:shadow-[0_12px_24px_rgba(151,110,42,0.08)] hover:-translate-y-1">
                    ...
                    <p className="text-[9px] font-poppins font-bold uppercase tracking-[0.2em] text-[#203B23] leading-snug">{item.text}</p>
                  </div>
                );
              })}
            </div>
          ...
          <div className="lg:col-span-6 space-y-12">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-poppins font-bold text-[#203B23] tracking-tight leading-[1.05]">
                {product.name}
              </h1>
              ...
              <div className="pt-2 flex items-center gap-6">
                <div className="flex items-baseline gap-4">
                  <span className="text-4xl font-poppins font-bold text-[#203B23]">₹{product.price}</span>
                ...
                {product.net_quantity && (
                  <span className="px-4 py-1.5 rounded-full bg-[#FFFDF6] text-[10px] font-poppins font-bold uppercase tracking-[0.2em] text-[#203B23] border border-[#E3DBC5] shadow-sm">
                    {product.net_quantity}
                  </span>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-5 items-end">
                ...
                <div className="sm:col-span-4 space-y-3">
                  ...
                  <div className="flex items-center justify-between bg-[#FFFDF6] rounded-[16px] p-1.5 border border-[#E3DBC5]/80 shadow-[0_4px_12px_rgba(32,59,35,0.03)]">
                    <button 
                      ...
                      className="w-12 h-12 flex items-center justify-center text-lg font-light text-[#203B23] hover:bg-[#FAF4E3] rounded-xl transition-colors"
                    >
                      −
                    </button>
                    <span className="font-poppins font-bold text-[#203B23] text-lg">{quantity}</span>
                    <button 
                ...
                <div className="sm:col-span-8 flex flex-col sm:flex-row gap-5 pt-8">
                  <button
                    ...
                    disabled={isInCart}
                    className={`flex-1 h-[72px] rounded-2xl font-poppins font-bold text-[11px] uppercase tracking-[0.4em] transition-all duration-500 shadow-2xl flex items-center justify-center gap-4 group ${
                      isInCart 
                      ? "bg-[#C45525] text-white cursor-default opacity-90" 
                      : "bg-[#203B23] text-[#FFFDF6] hover:bg-[#C45525] shadow-[#203B23]/20"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-[72px] h-[72px] rounded-2xl border-[1.5px] flex items-center justify-center transition-all duration-500 group ${
                      isWishlisted 
                      ? "bg-[#C45525] border-[#C45525] text-[#FFFDF6]" 
                      : "bg-white border-[#E3DBC5] text-[#203B23] hover:border-[#203B23]"
                    }`}
                  >
              ...
              <div className="flex gap-8 border-b border-[#E3DBC5] pb-4 overflow-x-auto no-scrollbar">
                {['description', 'ingredients', 'nutrition', 'preparation'].map((tab) => (
                  <button
                    ...
                    className={`text-[10px] font-poppins font-bold uppercase tracking-[0.25em] transition-all duration-300 relative pb-2 whitespace-nowrap ${
                      activeTab === tab ? 'text-[#203B23]' : 'text-[#203B23]/40 hover:text-[#976E2A]'
                    }`}
                  >
                    <span>{tab}</span>
                    {activeTab === tab && (
              ...
              <div className="min-h-[160px]">
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    className="text-sm leading-loose text-[#203B23]/80 font-poppins"
                  >
                    {activeTab === 'description' && (
                      <div className="space-y-4">
                        <p className="text-base text-[#203B23] leading-relaxed">
                    ...
                    {activeTab === 'ingredients' && (
                      <div className="bg-[#FFFDF6] p-8 rounded-[24px] border border-[#E3DBC5]/80 shadow-[0_4px_12px_rgba(32,59,35,0.03)]">
                        <p className="font-poppins italic text-[#203B23] text-base leading-relaxed">
                    ...
                    {activeTab === 'nutrition' && (
                      <div className="bg-[#FFFDF6] p-8 rounded-[24px] border border-[#E3DBC5]/80 shadow-[0_4px_12px_rgba(32,59,35,0.03)]">
                        <div className="font-poppins font-medium text-xs tracking-widest uppercase text-[#203B23] space-y-3 whitespace-pre-line leading-relaxed">
                    ...
                    {activeTab === 'preparation' && (
                      <div className="space-y-6">
                        <div className="bg-[#FFFDF6] p-8 rounded-[24px] border border-[#E3DBC5]/80 shadow-[0_4px_12px_rgba(32,59,35,0.03)]">
                          <p className="whitespace-pre-line font-poppins italic text-[#203B23] text-base leading-relaxed">
                        ...
                        <div className="p-5 rounded-[20px] bg-[#FFFDF6] border border-[#E3DBC5] shadow-[0_8px_24px_rgba(151,110,42,0.06)] flex gap-5 items-start">
                          ...
                          <div className="space-y-1.5 mt-0.5">
                            ...
                            <p className="text-xs text-[#203B23] font-poppins italic leading-relaxed">Incorporate a single compression swipe of organic lime juice and black salt for premium physiological activation.</p>
                          </div>
                        </div>
                      </div>
                    )}
