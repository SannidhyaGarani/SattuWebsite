        ...
        <div className="grid lg:grid-cols-12 gap-20 items-start">
          ...
          >
            <div className="space-y-6">
              ...
              <h2 className="text-4xl md:text-5xl font-poppins font-bold text-[#203B23] leading-tight uppercase">
                Initiate a <br />
                <span className="text-4xl md:text-5xl font-poppins font-bold text-[#203B23] leading-tight uppercase">Global Inquiry</span>
              </h2>
            ...
            <div className="space-y-6">
              {communicationChannels.map((item, i) => (
                ...
                >
                  <div className="w-16 h-16 rounded-2xl bg-[#FAF4E3] border border-[#E3DBC5] text-[#203B23] group-hover:bg-[#203B23] group-hover:text-white flex items-center justify-center transition-all duration-500 shrink-0">
                    {item.icon}
                  </div>
                  <div className="flex-1">
                    <p className="text-[10px] font-poppins font-bold uppercase tracking-[0.2em] text-[#976E2A] mb-1">{item.label}</p>
                    <p className="text-xl font-poppins font-bold text-[#203B23] tracking-tight">{item.val}</p>
                  </div>
            ...
            <div className="bg-[#FFFDF6] border-[1.5px] border-[#E3DBC5] rounded-[48px] p-10 md:p-16 shadow-2xl relative overflow-hidden group">
              <form className="space-y-10" onSubmit={handleFormSubmit}>
                <div className="grid sm:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <input 
                      type="text" 
                      required
                      className="w-full bg-[#FAF4E3]/30 border border-[#E3DBC5] rounded-2xl px-6 py-5 text-sm font-poppins font-medium text-[#203B23] outline-none focus:border-[#976E2A]/40 focus:bg-white transition-all shadow-inner" 
                ...
                <div className="space-y-3">
                  ...
                  <select className="w-full bg-[#FAF4E3]/30 border border-[#E3DBC5] rounded-2xl px-6 py-5 text-sm font-poppins font-medium text-[#203B23] outline-none focus:border-[#976E2A]/40 focus:bg-white transition-all shadow-inner appearance-none cursor-pointer">
                ...
                <div className="space-y-3">
                  ...
                  <textarea 
                    rows="5" 
                    required
                    className="w-full bg-[#FAF4E3]/30 border border-[#E3DBC5] rounded-2xl px-6 py-6 text-sm font-poppins font-medium text-[#203B23] outline-none focus:border-[#976E2A]/40 focus:bg-white transition-all resize-none shadow-inner" 
                ...
                <button 
                  type="submit"
                  className="w-full h-18 rounded-2xl bg-[#203B23] text-[#FAF4E3] font-poppins font-bold text-xs uppercase tracking-[0.3em] shadow-xl hover:bg-[#C45525] transition-all duration-500 flex items-center justify-center gap-4 group"
                >
